  ...
  return (
    <div className="bg-[#F6F4EE]">
      <div className="max-w-7xl mx-auto px-5 pb-12 pt-12 md:pt-16 lg:pt-24 space-y-10">
        <Tabs
          className={`grid grid-cols-1 lg:grid-cols-5 justify-between  gap-10`}
        >
          <TabList className={" flex flex-col  lg:col-span-2 gap"}>
            <div>
              <h1 className="text-4xl md:text-6xl text-[#031F42] font-medium pb-5">
                Campuses
              </h1>
            ...
            <div className="md:relative">
              ...
              <div className=" w-full md:absolute bottom-6 left-0 ">
                ...
                <div className="md:flex md:justify-between md:items-center space-y-3">
                    <p className=" flex items-center gap-x-3"><span className="border border-primary-800 rounded-full p-[10px]"><FaLocationDot size={16} className="text-primary-800"></FaLocationDot></span><span className="text-[#57585E] text-[15px]">197345, Russia, Saint- <br />Petersburg, Mebelnaya, 11A</span></p>
                    <button className="border rounded-md transition duration-300 hover:bg-primary-800  border-primary-800 py-[5px] px-3 text-primary-800 font-semibold hover:text-white text-lg"><span className="">Find out More</span></button>
                </div>
                </div>
              </div>
            </div>
