          ...
          <div className="w-full sm:w-11/12 md:w-3/5 mt-6 md:mt-10">
            <form className="space-y-5">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-8">
                ...
                />
                <input
                  className="w-full shadow-box py-3  px-3 rounded-[3px] outline-primary-800/80"
                  type="email"
                  name=""
                  id=""
                  placeholder="Email*"
              ...
              ></textarea>
              <input
                className="rounded-md py-3 px-6 font-semibold hover:bg-primary-800 flex justify-center items-center  text-primary-800 text-lg border hover:border-primary-800 border-primary-800/50  bg-primary-800/5 transition duration-500 hover:text-white"
                type="submit"
