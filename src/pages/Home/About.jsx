  ...
  return (
    <div className="max-w-7xl mx-auto bg-[#FFFFFF]  mt-28 mb-10 px-5">
      <div className="grid grid-cols-1 lg:grid-cols-2  gap-8  justify-center lg:justify-between">
        <div>
          <h2 className="text-lg md:text-xl  uppercase text-[#808080]  font-semibold">About Us</h2>
            ...
            <Tabs>
              ...
              <TabPanel>
                <div>
                  <p className="text-[#888888] text-lg my-6">
                    Magna aliquaenim minim veniam quis nostrud exercitation ullamco laborisLorem ipsum dolor sit amet consectetur adipisicing elit sed do eius
                    tempor incididunt labore.
                  </p>
                  <div className="mt-4 space-y-3">
                    <p className="text-lg flex flex-row gap-x-5 items-center font-semibold text-[#181818]">
                      <GiCheckMark size={25} className="text-[#EE4A62] "></GiCheckMark> <span>Education award achived</span>{" "}
                    </p>
                    <p className="text-lg flex flex-row gap-x-5 items-center font-semibold text-[#181818]">
                      <GiCheckMark size={25} className="text-[#EE4A62] "></GiCheckMark> <span>Available online courses</span>{" "}
                    </p>
                  </div>
                </div>
              </TabPanel>
              <TabPanel>
                <div>
                  ...
                  <div className="mt-4 space-y-3">
                    <p className="text-lg flex flex-row gap-x-5 items-center font-semibold text-[#181818]">
                      <GiCheckMark size={25} className="text-[#EE4A62] "></GiCheckMark> <span>Industry Expert Instructor</span>{" "}
                    </p>
                    <p className="text-lg flex flex-row gap-x-5 items-center font-semibold text-[#181818]">
                      <GiCheckMark size={25} className="text-[#EE4A62] "></GiCheckMark> <span>Up-to-Date Course Content</span>{" "}
                    </p>
                  </div>
                </div>
              </TabPanel>
              <TabPanel>
                <div>
                  ...
                  <div className="mt-4 space-y-3">
                    <p className="text-lg flex flex-row gap-x-5 items-center font-semibold text-[#181818]">
                      <GiCheckMark size={25} className="text-[#EE4A62] "></GiCheckMark> <span>Online Remote Learning</span>{" "}
                    </p>
                    <p className="text-lg flex flex-row gap-x-5 items-center font-semibold text-[#181818]">
                      <GiCheckMark size={25} className="text-[#EE4A62] "></GiCheckMark> <span>Lifetime Access For Learning</span>{" "}
                    </p>
                  </div>
                </div>
              </TabPanel>
        ...
        <div className="">
          <div className="relative flex flex-col  lg:items-center">
            <img className="rounded-xl w-[390px] h-[390px]" src={img_86} alt="pic" />
            <img
