  ...
  return (
    <div className="max-w-7xl mx-auto md:flex items-center mt-28 mb-20 px-5">
      ...
      <div className="md:min-w-[50%]">
        <p className="text-lg md:text-xl uppercase text-[#808080] font-semibold tracking-widest">
          Our Partners
        </p>

        <h1 className="text-4xl md:text-5xl text-[#181818] font-bold mt-6 leading-tight">
          Learn with <br />{" "}
          <span className="text-[#1AB69D]">Our Trusted Partners</span>
        </h1>
        ...
        <p className="text-gray-600 md:w-[500px] text-lg leading-relaxed">
          ...
          best learning experiences. Our partners share our commitment to
      ...
      <div className="md:w-1/2   mt-10 md:mt-0">
        ...
        <div className="bg-gradient-to-r from-[#F0F9F8] to-[#E6F4F1] p-6 rounded-xl">
     
          <Marquee direction="left" speed={50}>
            <div className="mx-4 my-2 p-4 bg-white rounded-lg shadow-md hover:scale-105 transform transition-all duration-300 cursor-pointer">
              <img
            ...
            <div className="mx-4 p-4 bg-white rounded-lg shadow-md hover:scale-105 transform transition-all duration-300 cursor-pointer">
              <img
                className="h-16 w-auto"
          ...
          <Marquee direction="right" speed={50}>
            ...
            <div className="mx-4 p-4 bg-white rounded-lg shadow-md hover:scale-105 transform transition-all duration-300 cursor-pointer">
              <img
                className="h-16 w-auto"
                src="https://demo.edublink.co/wp-content/uploads/2023/05/brand-07.png"
                alt="Partner Logo"
              />
            </div>
            <div className="mx-4 p-4 bg-white rounded-lg shadow-md hover:scale-105 transform transition-all duration-300 cursor-pointer">
              <img
                className="h-16 w-auto"
                src="https://demo.edublink.co/wp-content/uploads/2023/05/brand-08.png"
                alt="Partner Logo"
              />
            </div>
          </Marquee>
