          ...
          <div>
            ...
            <div className="pt-5 lg:pt-8">
              ...
              <div className="mt-8 bg-[#F3F5F6] flex justify-between py-3 px-4 gap-x-3 md:gap-x-5">
                ...
                <button className=" py-[1px]  text-[16px] px-2  font-semibold rounded-sm bg-white italic ">
                  <span>Pay</span><span className="text-primary-700">Pal</span>
                </button>
                <button className=" py-[1px]  text-[16px] px-2  font-bold rounded-sm bg-white italic ">
                  <span>VISA</span>
                </button>
