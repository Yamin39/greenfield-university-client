            ...
            <div className="">
              <p className="w-full flex justify-end text-end ">
                <span className="w-10 h-10 bg-[#8dddd0] hover:bg-red-500 transition duration-300 rounded-full text-end flex justify-center items-center">
                  <VscHeart size={20} className="text-white "></VscHeart>
                </span>
              </p>
              ...
              <p className="text-[18px] ">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor magnam atque repudiandae similique quibusdam iure vero facilis aperiam fugit
                sequi.
              </p>
