                           ...
                           <tbody>
                              {
                                 blogs.map((blog, i) => <tr key={i} className="border">
                                    ...
                                    <td className="p-2">
                                       <img src={blog?.author?.img ? blog.author?.img : 'https://greenfield-university.netlify.app/assets/banner_66-Bq6KXLtZ.png' } alt="" className="w-12 h-8 object-cover rounded-lg hover:scale-105 duration-300"/>
                                    </td>
                                    <td className="p-2">
                                    ...
                                    <td className="p-2">
                                       <Link to={`/dashboard/updateBlog/${blog._id}`} className="px-3 py-1 font-semibold rounded-md bg-green-500 text-white cursor-pointer">
                                          <span>Update</span>
                                       </Link>
                                    </td>
