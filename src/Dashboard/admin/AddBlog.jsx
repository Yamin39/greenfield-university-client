  ...
  return (
    <div>
      ...
      <form
        ...
        className="  border p-10 bg-slate-50 space-y-6 max-w-6xl mx-auto"
      >
        ...
        <div className="*:w-full space-y-1">
          ...
          <input
            type="file"
            name="thumbnail"
            className="border outline-green-500 file:p-2.5 file:border-none cursor-pointer file:cursor-pointer"
            required
          />
        </div>
        ...
        <div className="*:w-full space-y-1">
          ...
          <div className="flex items-center *:flex-grow gap-5 flex-col sm:flex-row *:w-full">
            <input
              type="text"
              name="name"
